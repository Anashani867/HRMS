...
<div class="col-12">
   <div class="card">
      ...
      <div class="card-body">
         <form action="{{ route('Employees.update', $info->id) }}" method="POST">
            @csrf
   ...
   <div class="card card-primary card-outline">
            ...
            <div class="row">
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input autofocus type="text" name="zketo_code" id="zketo_code" class="form-control" value="{{ old('zketo_code',$info['zketo_code']) }}" >
                     @error('zketo_code')
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input type="text" name="emp_name" id="emp_name" class="form-control" value="{{ old('emp_name',$info['emp_name']) }}" >
                     @error('emp_name')
                     <span class="text-danger">{{ $message }}</span> 
                     @enderror
                  </div>
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <option   @if(old('emp_gender', $info->emp_gender ??'')==1 )selected @endif  value="1">ذكر</option>
                     <option   @if(old('emp_gender', $info->emp_gender ??'') ==2)selected @endif value="1">انثي</option>
                     </select>
                     @error('emp_gender')
                     <span class="text-danger">{{ $message }}</span> 
                     @enderror
                          ...
                          @if(isset($other['branches']) && !empty($other['branches']))
                              @foreach ($other['branches'] as $branch)
                                  <option value="{{ $branch->id }}" 
                                      @if(old('branch_id', $info->branch_id ?? '') == $branch->id) selected @endif>
                                      {{ $branch->name }}
                                  </option>
                              @endforeach
                          @endif
                          ...
                          @if (isset($other['qualifications']) && !empty($other['qualifications']))
                              @foreach ($other['qualifications'] as $qualification)
                                  <option value="{{ $qualification->id }}" 
                                      @if(old('Qualifications_id', $info->Qualifications_id ?? '') == $qualification->id) selected @endif>
                                      {{ $qualification->name }}
                                  </option>
                              @endforeach
                          @endif
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input type="text" name="Qualifications_year" id="Qualifications_year" class="form-control" value="{{ old('Qualifications_year',$info['Qualifications_year']) }}" >
    ...
    <div class="form-group">
        ...
        <select name="graduation_estimate" id="graduation_estimate" class="form-control">
            <option value="1" @if(old('graduation_estimate', $info->graduation_estimate ?? '') == 1) selected @endif>مقبول</option>
            <option value="2" @if(old('graduation_estimate', $info->graduation_estimate ?? '') == 2) selected @endif>جيد</option>
            <option value="3" @if(old('graduation_estimate', $info->graduation_estimate ?? '') == 3) selected @endif>جيد مرتفع</option>
            <option value="4" @if(old('graduation_estimate', $info->graduation_estimate ?? '') == 4) selected @endif>جيد جداً</option>
            <option value="5" @if(old('graduation_estimate', $info->graduation_estimate ?? '') == 5) selected @endif>إمتياز</option>
        </select>
        ...
        @enderror
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input type="text" name="Graduation_specialization" id="Graduation_specialization" class="form-control" value="{{ old('Graduation_specialization',$info['Graduation_specialization']) }}" >
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input type="date" name="brith_date" id="brith_date" class="form-control" value="{{ old('brith_date',$info['brith_date']) }}" >
                     @error('brith_date')
                     <span class="text-danger">{{ $message }}</span> 
                     @enderror
                  </div>
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input type="text" name="emp_national_idenity" id="emp_national_idenity" class="form-control" value="{{ old('emp_national_idenity',$info['emp_national_idenity']) }}" >
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input type="text" name="emp_identityPlace" id="emp_identityPlace" class="form-control" value="{{ old('emp_identityPlace',$info['emp_identityPlace']) }}" >
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input type="date" name="emp_end_identityIDate" id="emp_end_identityIDate" class="form-control" value="{{ old('emp_end_identityIDate',$info['emp_end_identityIDate']) }}" >
                          ...
                          @if (@isset($other['blood_groups']) && !@empty($other['blood_groups']))
                              @foreach ($other['blood_groups'] as $info)
                                  <option value="{{ $info->id }}"
                                      @if(old('blood_group_id', $info->id) == $info->id) selected="selected" @endif>
                                      {{ $info->name }}
                                  </option>
                              @endforeach
                          @endif
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <select name="emp_nationality_id" id="emp_nationality_id" class="form-control select2 ">
                        ...
                        <option value="{{ $info->id }}" @if(old('emp_nationality_id', $info->id) == $info->id) selected="selected" @endif> {{ $info->name }} </option>
                        @endforeach
                        @endif
                     </select>
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <select name="emp_lang_id" id="emp_lang_id" class="form-control select2 ">
                        ...
                        <option value="{{ $info->id }}" @if(old('emp_lang_id', $info->id) == $info->id) selected="selected" @endif> {{ $info->name }} </option>
                        @endforeach
                        @endif
                     </select>
                     @error('emp_lang_id')
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <select name="religion_id" id="religion_id" class="form-control select2 ">
                        ...
                        <option value="{{ $info->id }}"
                            @if(old('religion_id', $info->id) == $info->id) selected="selected" @endif> {{ $info->name }} </option>
                        @endforeach
                        @endif
                     </select>
                     @error('religion_id')
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input type="text" name="emp_email" id="emp_email" class="form-control" value="{{ old('emp_email', $info->emp_email) }}">
                     @error('emp_email')
                     <span class="text-danger">{{ $message }}</span> 
                     @enderror
                  </div>
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <select name="country_id" id="country_id" class="form-control select2 ">
                        ...
                        <option value="{{ $info->id }}"
                            @if(old('countires', $info->id) == $info->id) selected="selected" @endif> {{ $info->name }} </option>
                        @endforeach
                        @endif
                     </select>
                     @error('country_id')
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input type="text" name="staies_address" id="staies_address" class="form-control" value="{{ old('staies_address',$info['staies_address']) }}" >
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input type="text" name="emp_home_tel" id="emp_home_tel" class="form-control" value="{{ old('emp_home_tel',$info['emp_home_tel']) }}" >
                     @error('emp_home_tel')
                     <span class="text-danger">{{ $message }}</span> 
                     @enderror
                  </div>
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input type="text" name="emp_work_tel" id="emp_work_tel" class="form-control" value="{{ old('emp_work_tel',$info['emp_work_tel']) }}" >
                     @error('emp_work_tel')
                     <span class="text-danger">{{ $message }}</span> 
                     @enderror
                  </div>
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <select name="emp_military_id" id="emp_military_id" class="form-control select2 ">
                        ...
                        <option value="{{ $info->id }}"
                            @if(old('emp_military_id', $info->id) == $info->id) selected="selected" @endif> {{ $info->name }} </option>
                        @endforeach
                        @endif
                     </select>
                     @error('country_id')
               ...
               <div class="col-md-4 related_miltary_1"  style="display: none;">
                  <div class="form-group">
                     ...
                     <input type="date" name="emp_military_date_from" id="emp_military_date_from" class="form-control" value="{{ old('emp_military_date_from',$info['emp_military_date_from']) }}" >
               ...
               <div class="col-md-4 related_miltary_1"  style="display: none;">
                  <div class="form-group">
                     ...
                     <input type="date" name="emp_military_date_to" id="emp_military_date_to" class="form-control" value="{{ old('emp_military_date_to',$info['emp_military_date_to']) }}" >
               ...
               <div class="col-md-4 related_miltary_1"  style="display: none;">
                  <div class="form-group">
                     ...
                     <input type="text" name="emp_military_wepon	" id="emp_military_wepon	" class="form-control" value="{{ old('emp_military_wepon',$info['emp_military_wepon']) }}" >
               ...
               <div class="col-md-4 related_miltary_2"  style="display: none;">
                  <div class="form-group">
                     ...
                     <input type="date" name="exemption_date" id="exemption_date" class="form-control" value="{{ old('exemption_date',$info['exemption_date']) }}" >
               ...
               <div class="col-md-4 related_miltary_2"  style="display: none;">
                  <div class="form-group">
                     ...
                     <input type="text" name="exemption_reason" id="exemption_reason" class="form-control" value="{{ old('exemption_reason',$info['exemption_reason']) }}" >
               ...
               <div class="col-md-4 related_miltary_3"  style="display: none;">
                  <div class="form-group">
                     ...
                     <input type="text" name="postponement_reason" id="postponement_reason" class="form-control" value="{{ old('postponement_reason',$info['postponement_reason']) }}" >
               ...
               <div class="col-md-4">
                  <div class="form-group">
                      ...
                      <select name="does_has_Driving_License" id="does_has_Driving_License" class="form-control">
                          <option value="">اختر الحالة</option>
                          <option @if(old('does_has_Driving_License', $info->does_has_Driving_License ?? '')==1) selected @endif value="1">نعم</option>
                          <option @if(old('does_has_Driving_License', $info->does_has_Driving_License ?? '') == 0) selected @endif value="0">لا</option>
                        </select>
               ...
               <div class="col-md-4 related_does_has_Driving_License"  style="display: none;">
                  <div class="form-group">
                     ...
                     <input type="text" name="driving_License_degree" id="driving_License_degree" class="form-control" value="{{ old('driving_License_degree',$info['driving_License_degree']) }}" >
               ...
               <div class="col-md-4 related_does_has_Driving_License"  style="display: none;">
                  <div class="form-group">
                     ...
                     <select name="driving_license_types_id" id="driving_license_types_id" class="form-control select2 ">
                        ...
                        <option value="{{ $info->id }}"
                         @if(old('driving_license_types_id', $info->id) == $info->id) selected="selected" @endif > {{ $info->name }} </option>
                        @endforeach
                        @endif
                     </select>
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <select name="has_Relatives" id="has_Relatives" class="form-control">
                        <option value="">اختر الحالة</option>
                        <option @if(old('has_Relatives', $info->has_Relatives ?? '') == 1) selected @endif value="1">نعم</option>
                        <option @if(old('has_Relatives', $info->has_Relatives ?? '') == 0) selected @endif value="0">لا</option>
                     </select>
                     @error('has_Relatives')
                        <span class="text-danger">{{ $message }}</span>
                     @enderror
            ...
            <div class="col-md-4">
               <div class="form-group">
                  ...
                  <select name="emp_jobs_id" id="emp_jobs_id" class="form-control select2">
                     ...
                     <option @if(old('emp_jobs_id')==$info->id) selected="selected" @endif value="{{ $info->id }}"> {{ $info->name }} </option>
                     @endforeach
                     @endif
                  </select>
                  @error('emp_jobs_id')
            ...
            <div class="col-md-4 relatedfixced_shift"  @if(old('do_has_shift')!=1) style="display: none;" @endif>
               <div class="form-group">
                  ...
                  <select name="shift_type_id" id="shift_type_id" class="form-control select2 ">
                     ...
                     <option @if(old('shift_type_id')==$info->id) selected="selected" @endif value="{{ $info->id }}"> 
