                      ...
                      <select name="branch_id" id="branch_id" class="form-control select2">
                          ...
                          @if (@isset($other['branches']) && !@empty($other['branches']))
                              @foreach ($other['branches'] as $info)
                                  <option @if(old('branch_id') == $info->id) selected="selected" @endif value="{{ $info->id }}"> {{ $info->name }} </option>
                              @endforeach
                          @endif
                      </select>
                      @error('branch_id')
               ...
               <div class="col-md-4">
                  <div class="form-group">
                      ...
                      <select name="does_has_Driving_License" id="does_has_Driving_License" class="form-control">
                          <option value="">اختر الحالة</option>
                          <option @if(old('does_has_Driving_License')==1) selected @endif value="1">نعم</option>
                          <option @if(old('does_has_Driving_License')==0 and old('does_has_Driving_License')!="" ) selected @endif value="0">لا</option>
                      </select>
