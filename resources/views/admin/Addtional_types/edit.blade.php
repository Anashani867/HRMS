...
<div class="col-12">
   <div class="card">
      <div class="card-header">
         <h3 class="card-title card_title_center">  تعديل بيانات نواع الاضافي للراتب
         </h3>
      </div>
      <div class="card-body">
         <form action="{{ route('AddtionalTypes.update',$data['id']) }}" method="post">
            @csrf
            <div class="col-md-12">
            ...
            <div class="col-md-12">
               <div class="form-group text-center">
                  ...
                  <a href="{{ route('AddtionalTypes.index') }}" class="btn btn-danger btn-sm">الغاء</a>
               </div>
            </div>
         </form>
      </div>
